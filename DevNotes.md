...
2. Получите токен бота для сообщества Vkontakte
...
По умолчанию данные сохраняются в sqlite базе данных в директории `data/`. Вы можете изменить директорию, установив переменную `DATA_DIR` в файле `.env`.
